...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addToValue: function addToValue(field, event) {
  ...
  methods: {
    ...
    getCategories: function getCategories() {
      ...
      this.axios.get('/api/categories').then(function (response) {
        _this2.categories = response.data.fields;
        _this2.isLoad = false;
      });
    },
        ...
        [
          _c("div", { staticClass: "row" }, [
            ...
            _c("div", { staticClass: " col s12 m12 l12" }, [
              _c("p", [_vm._v("Всего за день: " + _vm._s(_vm.cTotalAmount))])
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "row" }, [
      ...
      _c(
        ...
        [
          ...
          _c(
            "div",
            { staticClass: "row" },
            _vm._l(_vm.cCategories, function(category) {
              return _c("div", { staticClass: "input-field col s12 m12 l6" }, [
                _c("input", {
                  directives: [
                    {
                ...
                _vm._v(" "),
                _c("label", { staticClass: "active", attrs: { for: "name" } }, [
                  _vm._v("Поле " + _vm._s(category.id))
                ])
              ])
            }),
            0
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "row" }, [_c("h3", [_vm._v("Login")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "row" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "col s12 m12 l12" }, [
              _c("p", [_vm._v("Всего за период: " + _vm._s(_vm.cTotalAmount))])
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "row" }, [
